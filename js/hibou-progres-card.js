// V25.7.54 — Carte Mes progrès de l'accueil.
...
(function(){
  ...
  function openMedals(ev){
    ...
    /* V25.7.54 : la ligne « Mes médailles » ouvre exactement la même vue fiable
  ...
  function render(){
    ...
    // V25.7.54 : une seule identité visuelle dans l'en-tête.
