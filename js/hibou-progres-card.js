// V25.7.57 — Carte Mes progrès de l'accueil.
...
(function(){
  ...
  function openMedals(ev){
    ...
    /* V25.7.57 : la ligne « Mes médailles » ouvre exactement la même vue fiable
  ...
  function render(){
    ...
    // V25.7.57 : une seule identité visuelle dans l'en-tête.
